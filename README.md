...
**Текущая реализация (Итерации 1-5):**
- **TelegramBot** - обработка текстовых сообщений от пользователей (polling)
- **DialogueManager** - управление контекстом диалогов в памяти
- **LLMClient** - интеграция с OpenRouter API
- **Config** - управление конфигурацией из .env и загрузка системного промпта из файла
...
- [`docs/vision.md`](docs/vision.md) - техническое видение и детальная спецификация (целевое состояние)
...
Подробный план разработки см. в [`docs/tasklist.md`](docs/tasklist.md)
