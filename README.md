...
- 🌐 **Веб-интерфейс** - дашборд со статистикой и веб-чат
- 💬 **Chat API** - REST API для взаимодействия с LLM (normal + admin режимы)
- 🧠 **Мультимодальная LLM** - работа с языковыми моделями через OpenRouter API
- 🗣️ **Text2SQL** - админ режим для вопросов по статистике через SQL
...
**Stats API & Chat API (FastAPI):**
- **Stats Collector** - сбор статистики с Mock/Real реализациями
- **Chat Service** - обработка чат-запросов (Normal/Admin режимы)
- **Auth** - JWT аутентификация для админ режима
- **Text2SQL** - преобразование вопросов в SQL запросы
- **Cache** - in-memory кэширование с TTL
- **Models** - Pydantic модели для API

**Frontend (Next.js 15 + React 19):**
- **Dashboard** - статистика диалогов с графиками
- **Chat UI** - веб-чат с floating button
- **Components** - shadcn/ui компоненты
- **Hooks** - useChat, useChatAuth, useStats
- **API Client** - axios интеграция с backend
