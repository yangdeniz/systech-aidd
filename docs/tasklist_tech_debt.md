...
- [ ] ✅ Соответствует принципам KISS из `conventions.md` (стандартные инструменты)
...
**Проверка соответствия:**
- [ ] ✅ Код остается простым и понятным (`conventions.md`)
- [ ] ✅ Типы помогают понять API без документации (`conventions.md`)
- [ ] ✅ Не добавляем избыточных абстракций (`conventions.md`)
...
**Проверка соответствия:**
- [ ] ✅ Тесты простые и понятные (`conventions.md`)
...
**Проверка соответствия:**
- [ ] ✅ Минимум новых абстракций - только для ключевых зависимостей (`conventions.md`)
- [ ] ✅ Protocol проще, чем ABC - выбираем Protocol (`conventions.md`)
- [ ] ✅ Не создаем избыточных уровней абстракции (`conventions.md`)
